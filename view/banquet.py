...
class BanquetView(BaseView):
    def __init__(self):
        ...
        self.set_admin_commands_description({
            "Banquet create <name> <date_and_time> <address> <location> <staff_no> <available> <quota>": "create a banquet record",
            "Banquet update <name> <date_and_time> <address> <location> <staff_no> <available> <quota>": "update a banquet record"
        })